...
CREATE TABLE IF NOT EXISTS manuals (
  ...
  jumper_settings TEXT, -- JSON Array em String
  tags TEXT, -- JSON Array em String
...
-- Inserir Dados Iniciais de Marcas Eletrozone
...
-- Inserir Dados Iniciais de Categorias Eletrozone
